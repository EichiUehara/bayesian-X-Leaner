...
(\S\ref{sec:experiments}) confirms both pathways work as
...
\begin{enumerate}
  ...
  \item An explicit separation of \emph{tails-as-contamination} and
    ...
    (\S\ref{sec:experiments:tail_signal}) and a graded
    basis-sensitivity ablation
    (\S\ref{sec:experiments:basis_ablation}) showing which
  ...
  \item Empirical validation of Huber's 1964 minimax-$\delta$
    ...
    (\S\ref{sec:method:severity}), with documented breakdown
    beyond 30\%.
