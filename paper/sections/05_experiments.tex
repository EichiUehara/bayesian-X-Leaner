...
$\sim\$1{,}700$ Lalonde-NSW estimate. \texttt{severity="none"} with
the same pre-standardisation gives $+\$253$ with much wider CI
...
$\hat{\mathbb{E}}[Y \mid W=1] = 1.39$ vs $\hat{\mathbb{E}}[Y \mid W=0] = 0.65$, hence
...
($\alpha = 2$ corresponds to $\mathbb{E}[Y^2]$ on the verge of divergence). At
