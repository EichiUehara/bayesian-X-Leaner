...
Phase 2 of our pipeline (\S\ref{sec:method}) --- and inherits
its rate properties.
...
$\mathbb{E}[\psi_\delta^2] / \mathbb{E}[\psi'_\delta]^2$ and is $\approx 95\%$ at
...
contamination (\S\ref{sec:experiments:coverage}) is the
...
approach (\S\ref{sec:experiments:tail_signal}) is simpler and
...
\S\ref{sec:experiments:hetero_evt_phase3} and flag a
...
layer, but \S\ref{sec:experiments:tail_signal} shows it is
